...
describe LogStash::Filters::HTTPhash do
  describe "A bunch of URL's" do
    ...
    sample("input_url" => "http://barbon.mx") do
  ...
  describe "Another url" do
    let(:config) do <<-CONFIG
      filter {
        httphash {
          input_url => "https://propiedadescom.s3.amazonaws.com/files/600x400/novena-1234-mexicali-playas-de-rosarito-baja-california-norte-1649546-foto-01.jpg"
    ...
    sample("input_url" => "https://propiedadescom.s3.amazonaws.com/files/600x400/novena-1234-mexicali-playas-de-rosarito-baja-california-norte-1649546-foto-01.jpg") do
